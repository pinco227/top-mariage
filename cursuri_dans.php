...
$intrari_totale2 = mysqli_num_rows(mysqli_query($conexiune, 'SELECT * FROM `articole` WHERE `pag`="Cursuri Dans"'));
...
$intrari_totale = mysqli_num_rows(mysqli_query($conexiune, 'SELECT * FROM `imagini` WHERE `pentru`="cursuri_dans"'));
if ($intrari_totale == 0) {
	echo '';
} else {
	echo
