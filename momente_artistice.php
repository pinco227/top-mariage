...
$intrari_totale2 = mysqli_num_rows(mysqli_query($conexiune, 'SELECT * FROM `articole` WHERE `pag`="Momente Artistice"'));
...
$intrari_totale = mysqli_num_rows(mysqli_query($conexiune, 'SELECT * FROM `imagini` WHERE `pentru`="momente_artistice"'));
if ($intrari_totale == 0) {
	echo '';
} else {
	echo
