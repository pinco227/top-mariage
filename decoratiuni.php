...
$intrari_totale2 = mysqli_num_rows(mysqli_query($conexiune, 'SELECT * FROM `articole` WHERE `pag`="Decoratiuni"'));
...
$intrari_totale = mysqli_num_rows(mysqli_query($conexiune, 'SELECT * FROM `imagini` WHERE `pentru`="decoratiuni"'));
if ($intrari_totale == 0) {
	echo '';
} else {
	echo
