...
$cerereSQL = 'SELECT * FROM `categorii` WHERE `nume`="Traditii" ';
...
echo '
	<p align="center"><font size="5"><b>Traditii</b></font></p>
	<p align="center"><img src="images/a.gif" alt=""></p>';

$cerereSQL = 'SELECT * FROM `subcategorii` WHERE `cat`="Traditii" ORDER BY `nrordine` ASC';
$rezultat = mysqli_query($conexiune, $cerereSQL);
while ($rand = mysqli_fetch_assoc($rezultat)) {
	echo '
